...
class TestAudioRecorder:
    ...
    @patch("whosspr.core.sd.InputStream")
...
class TestTranscriber:
    ...
    @patch("whosspr.core.torch.cuda.is_available", return_value=False)
    @patch("whosspr.core.torch.backends.mps.is_available", return_value=False)
    def test_get_device_cpu(self, mock_mps, mock_cuda):
        """Test device detection returns CPU."""
        transcriber = Transcriber()
        assert transcriber._get_device() == "cpu"
    
    @patch("whosspr.core.torch.cuda.is_available", return_value=True)
    ...
    @patch("whosspr.core.torch.cuda.is_available", return_value=False)
    @patch("whosspr.core.torch.backends.mps.is_available", return_value=True)
    ...
    @patch("whosspr.core.whisper.load_model")
    @patch("whosspr.core.torch.cuda.is_available", return_value=False)
    @patch("whosspr.core.torch.backends.mps.is_available", return_value=False)
...
class TestTextInserter:
    ...
    @patch("whosspr.core.pyperclip.copy")
...
class TestKeyboardShortcuts:
    ...
    @patch("whosspr.core.keyboard.Listener")
...
class TestPermissions:
    ...
    @patch("whosspr.core.subprocess.run")
    ...
    @patch("whosspr.core.check_microphone_permission")
    @patch("whosspr.core.check_accessibility_permission")
