# WhOSSper Flow - Installation & Setup Instructions

This guide covers the complete setup of WhOSSper Flow on macOS, including permissions, dependencies, and first run.
...
# 2. Install WhOSSper (from project directory)
uv sync
